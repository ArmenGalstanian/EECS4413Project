...
<%--  Contains everything on the left column of the main web page --%>
<div class="leftbar">
    <ul id="menu">
        <li>
            <div>
	...
	<div>
		<form method='get' action='/ElectronicStore/jsp/AdminView.jsp'>
			<input type='submit' value='Admin' style ="margin-top: 10px; margin-left: 38px;">
		</form>
	</div>
